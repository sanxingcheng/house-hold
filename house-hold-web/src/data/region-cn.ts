...
const CHINA_PROVINCES: RegionNode[] = [
  {
    label: '北京市', value: '北京市',
    children: [
      { label: '东城区', value: '东城区' },
...
export const COUNTRY_OPTIONS: RegionNode[] = [
  {
    label: '中国', value: '中国',
    children: CHINA_PROVINCES,
  },
]

export function getProvinces(country: string): RegionNode[] {
  const c = COUNTRY_OPTIONS.find(c => c.value === country)
  return c?.children ?? []
}

export function getCities(country: string, province: string): RegionNode[] {
